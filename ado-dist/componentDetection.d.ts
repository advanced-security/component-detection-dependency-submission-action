...
export default class ComponentDetection {
    ...
    static setPlatformProvider(provider: IPlatformProvider): void;
    static scanAndGetManifests(path: string, platform?: IPlatformProvider): Promise<Manifest[] | undefined>;
